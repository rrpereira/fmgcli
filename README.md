...
- `FMG_E2E_TOKEN` and `FMG_E2E_ADOM` — required for API-key e2e tests (`TestE2E_LockUnlock`, `TestE2E_GetAddressByName`, `TestE2E_GetPolicyByID`, `TestE2E_GetPolicyByMetafield`, `TestE2E_GetPoliciesByMetafield`, `TestE2E_GetServiceByNamePortAndProtocol`)
